...
module.exports = {
	...
	execute: async (client, message, args, Client) => {
        ...
        const embed = new MessageEmbed().setDescription(`⭕ My prefix in this server is \`${settings.has(`${message.guild.id}.prefix`) ? settings.get(`${message.guild.id}.prefix`) : '!'}\``).setColor("#ffbe42")
